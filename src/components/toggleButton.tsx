...
const ToggleButton = () => {
    ...
    const mode: any = useSelector((state) => state);
    ...
    return (
        <>
            <div className='toggle-button flex justify-center' onClick={switchDarkMode}>
                <input type="checkbox" className="cursor-pointer absolute opacity-0 z-10 w-12 h-7" id="checkbox" />
                <label htmlFor="checkbox" className="relative p-1 justify-between items-center rounded-full flex w-12 h-7 bg-slate-500">
                    ...
                    <div className="ball w-5 h-5 bg-white absolute top-1 left-1 rounded-full transition-all" ></div>
                </label>
